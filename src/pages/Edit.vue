<template>
    ...
    <BackButton path="/">
      <span class="text-gray-200 uppercase text-sm font-semibold">Atualizar um usuário</span>
    </BackButton>

    <div class="flex items-center mt-8">
      <h1 class="text-md text-gray-200 uppercase font-semibold">Altere alguma informação abaixo</h1>
      <box-icon name='chevron-right' color="#E5E7EB"></box-icon>
    </div>

    <form @submit.prevent="update" class="w-full flex flex-col mt-2 overflow-auto h-full-165px md:h-auto">
